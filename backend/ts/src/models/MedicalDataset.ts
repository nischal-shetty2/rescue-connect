...
export const cowDiseases: Record<string, string> = {
  ...
  'Ecthyma (Contagious Pustular Dermatitis)':
    'Topical antiseptics, isolate infected animals, autogenous vaccine in severe outbreaks, zinc oxide ointment for healing',
  Respiratory:
  ...
  'Skin Disease':
    'Topical antifungals (Enilconazole, Iodine), acaricides for parasites (Amitraz, Ivermectin), maintain hygiene and reduce humidity',
}
